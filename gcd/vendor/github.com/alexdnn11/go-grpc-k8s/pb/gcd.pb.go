...
var fileDescriptor_178e0e204cde370a = []byte{
	...
	0x2d, 0x2e, 0xcd, 0x29, 0x81, 0x2a, 0x85, 0xf2, 0x8c, 0x32, 0xc0, 0x86, 0x06, 0xa7, 0x16, 0x95,
	0x65, 0x26, 0xa7, 0x0a, 0xe9, 0x72, 0x71, 0xb8, 0xa7, 0xe6, 0xa5, 0x16, 0x25, 0x96, 0xa4, 0x0a,
	0xf1, 0xe9, 0x15, 0x24, 0xe9, 0x21, 0x2c, 0x94, 0xe2, 0x87, 0xf3, 0x21, 0x46, 0x2a, 0x31, 0x08,
	0x69, 0x73, 0xb1, 0x85, 0xa5, 0x16, 0x65, 0xa6, 0x55, 0x12, 0xa1, 0x38, 0x89, 0x0d, 0xec, 0x13,
	0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x53, 0x65, 0x37, 0x50, 0xd6, 0x00, 0x00, 0x00,
}
...
type GCDServiceClient interface {
	Generate(ctx context.Context, in *GCDRequest, opts ...grpc.CallOption) (*GCDResponse, error)
	Verify(ctx context.Context, in *GCDRequest, opts ...grpc.CallOption) (*GCDResponse, error)
}
...
func (c *gCDServiceClient) Generate(ctx context.Context, in *GCDRequest, opts ...grpc.CallOption) (*GCDResponse, error) {
	out := new(GCDResponse)
...
func (c *gCDServiceClient) Verify(ctx context.Context, in *GCDRequest, opts ...grpc.CallOption) (*GCDResponse, error) {
	out := new(GCDResponse)
...
type GCDServiceServer interface {
	Generate(context.Context, *GCDRequest) (*GCDResponse, error)
	Verify(context.Context, *GCDRequest) (*GCDResponse, error)
}
...
func (*UnimplementedGCDServiceServer) Generate(ctx context.Context, req *GCDRequest) (*GCDResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Generate not implemented")
}
func (*UnimplementedGCDServiceServer) Verify(ctx context.Context, req *GCDRequest) (*GCDResponse, error) {
...
func _GCDService_Generate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GCDServiceServer).Generate(ctx, req.(*GCDRequest))
	}
...
func _GCDService_Verify_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GCDServiceServer).Verify(ctx, req.(*GCDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
